...
charbuffer.o: charbuffer.c charbuffer.h
	$(CC) -c $(CPPFLAGS) $(CFLAGS) -o $@ charbuffer.c
...
check:
	...
	do \
	  ...
	  ( $(CC)    $(CPPFLAGS) $(OTHER_INCLUDE) $(CFLAGS) $(OTHER_SOURCE) \
		-o t/a.out $$i.c charbuffer.c $(LDFLAGS) ) \
	  && ( t/a.out ); \
	done 
...
check-examples:
	...
	do \
	  ...
	  ( $(CC) -g $(CPPFLAGS) $(OTHER_INCLUDE) $(CFLAGS) $(OTHER_SOURCE) \
		-o ex/a.out $$i.c charbuffer.c $(LDFLAGS) ) \
...
echeck:
	...
	do \
	  ...
	  echo "Running test $$i ..."; \
	  ( $(CC)    $(CPPFLAGS) $(OTHER_INCLUDE) $(CFLAGS) $(OTHER_SOURCE) \
		-o t/a.out $$i.c charbuffer.c $(LDFLAGS_EFENCE) ) \
	  && ( LD_PRELOAD=libefence.so ./t/a.out ); \
	done 

indent:
	@indent $(INDENT_FLAGS) charbuffer.c
	@indent $(INDENT_FLAGS) charbuffer.h
	@indent $(INDENT_FLAGS) t/test.c
	@indent $(INDENT_FLAGS) ex/ex01.c

stamp:
	@$(STAMPER) charbuffer.c
	@$(STAMPER) charbuffer.h
